...
const view = () => {
  ...
  return (
            ...
            <div>
                <header className='py-5'>
                    <div className='container mx-auto'>
                            <div className='flex justify-center gap-x-[590px]'>
            ...
            <div className=''>
                    <section className='text-white bg-homeBg w-full h-full bg-cover bg-no-repeat'>
                                        ...
                                        <div className=''>
                                                <div className='rounded-2xl max-w-[300px] bg-gray-600 p-1 mb-6 pl-1 pr-3'>
                                                    <div className='flex items-center justify-between'>
                                                        <div className='bg-white rounded-full uppercase text-gray-400 text-xs py-1 px-4'>70% save</div>
                                            ...
                                            <div className='text max-w-[500px]'>
                                                ...
                                                <div className='py-3'>
                                                        <button className='bg-blue-600 text-white rounded-3xl flex gap-x-4 items-center capitalize px-4 py-1'>
                                                            try for FREE
                                                            <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" className="bg-white py-1 rounded-full w-8 h-8 text-blue-500 px-2 aos-init aos-animate" data-aos="fade-right" data-aos-offset="100" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M10 17l5-5-5-5v10z"></path><path fill="none" d="M0 24V0h24v24H0z"></path></svg>
                                                        </button>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <section className='pt-20 text-white max-w-[1800px]'>
                            <div className='container mx-auto'>
                                    <div className='flex flex-col items-center lg:justify-center lg:flex-row w-full gap-y-6 gap-x-[310px]'>
                    ...
                    <section className='pt-10 text-white'>
                            <div className='container mx-auto'>
                                    <div className='flex flex-col justify-center items-center gap-x-8 lg:flex-row'>
                                            <div className='order-2 lg:order-1'>
                                                <img src={ why } alt='' />
                                            </div>
                                            <div className='text max-w-[600px] order-1 lg:order-2'>
                    ...
                    <section className='pt-14'>
                            <div className='container mx-auto'>
                                    <div className='text-white text-center mb-10'>
                                            <h2 className='text-center capitalize mb-5 font-semibold text-2xl'> how much can you earn with us</h2>
                                            <p className='text-gray-400 text-xs text-center'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro, id similique temporibus dignissimos tempore odio?</p>
                                    </div>
                                    <div className='w-full bg-white max-w-[942px] mx-auto rounded-2xl text-darkblue p-6 lg:p-12 shadow-primary relative'>
                                        <form className='flex flex-col lg:flex-row lg:justify-between lg:items-center space-y-12 lg:space-y-0'>
                                                <input type='text' placeholder='Enter your hash rate' className='text-black w-1/2 text-xl border-b outline-none' />
                                                <select className="select w-40 h-8 outline-none cursor-pointer">
                                        ...
                                        <div className='mt-10'>
                                                <div className="text-blue-500 mb-4 flex justify-start">ESTIMATED 24 HOUR REVENUE:</div>
                                                <div className="text-[32px] font-bold mb-3 flex justify-start">0.055 130 59 ETH <span className="text-blue-600">($1275)</span></div>
                                                <div className="text-gray-500 flex justify-start">Revenue will change based on mining difficulty and Ethereum price.</div>
                                        </div>
                                    </div>
                            </div>
                    </section>

                    <section className='section pt-[100px] pb-12 lg:pt-[220px] bg-gray-100 w-full -mt-32'>
                            <div className='container mx-auto'>
                                <h2 className="text-2xl capitalize font-semibold text-center mb-16">Trade securely and market the high growth cryptocurrencies.</h2>
                                <div className="flex flex-col gap-[45px] lg:flex-row px-0 lg:px-8 justify-center">
                                            <div className="bg-violet-900 text-white  rounded-2xl py-12 px-6 shadow-primary  w-96 cursor-pointer transition ease-in duration-300">
                                            ...
                                            <div className="bg-white  rounded-2xl py-12 px-6 shadow-primary cursor-pointer w-96 transition ease-in duration-300">
                                                    <div className="flex flex-col justify-center items-center">
                                                        ...
                                                        <button className="text-blue w-16  border-2 border-gray-300 rounded-full h-16 flex justify-center items-center"><svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" className="text-3xl" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M294.1 256L167 129c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.3 34 0L345 239c9.1 9.1 9.3 23.7.7 33.1L201.1 417c-4.7 4.7-10.9 7-17 7s-12.3-2.3-17-7c-9.4-9.4-9.4-24.6 0-33.9l127-127.1z"></path></svg></button>
                                                    </div>
                                            </div>
                                            <div className="bg-white rounded-2xl py-12 px-6 shadow-primary cursor-pointer w-96 transition ease-in duration-300">
                                                    <div className="flex flex-col justify-center items-center">
                    ...
                    <section className='py-12 text-white'>
                                <div className='container mx-auto'>
                                            <div className='text text-center capitalize max-w-[758px] mx-auto mb-14'>
                                                    <h1 className='text-2xl lg:text-3xl'>  Market sentiments, portfolio, and run the infrastructure of your choice  </h1>
                                            </div>
                                            <section className='py-6'>
                                                    <div className='container mx-auto'>
                                                        <div className='flex flex-col lg:flex-row gap-x-8 justify-center items-start'>
                                                                <div className='max-w-[500px]'>
                                                                    <h1 className="text-2xl mb-5 capitalize font-semibold aos-init aos-animate">invest smart</h1>
                                                                    ...
                                                                    <div className="py-6"><button class="p-2 bg-blue-500 rounded-full px-4 text-xs">learn more</button></div>
                                                                </div>
                                                                <div className=''>
                                            ...
                                            <section className='py-16'>
                                                    <div className='container mx-auto'>
                                                        <div className='flex flex-col lg:flex-row justify-center items-center gap-x-[40px]'>
                                                                <div className='order-2 lg:order-1'>
                                                                    <img src={ feature_2 } alt='' />
                                                                </div>
                                                                <div className='text max-w-[500px] order-1 lg:order-2'>
                                                                    <h1 className="text-2xl mb-5 capitalize font-semibold text-white">detailed statistics</h1>
                                                                    <p className="text-gray-400 text-xs">Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero deserunt commodi quos adipisci! Corporis, vero?</p>
                                                                    <div className="py-6"><button className="p-2 bg-blue-500 rounded-full px-4 text-xs">learn more</button></div>
                                                                </div>
                                                        </div>
                                                    </div>
                                            </section>
                                            ...
                                            <section className='py-16'>
                                                    <div className='container mx-auto'>
                                                        <div className='flex flex-col items-center justify-center lg:flex-row gap-x-8'>
                                                                <div className='text max-w-[500px]'>
                                                                    <h1 className="text-2xl mb-5 capitalize font-semibold text-white">Grow your profit and track your investments</h1>
                                                                    <p className="text-gray-400 text-xs">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit enim odit distinctio dolore id incidunt?</p>
                                                                    <div className="py-6"><button className="p-2 bg-blue-500 rounded-full px-4 text-xs">learn more</button></div>
                                                                </div>
                                                                <div className=''>
                    ...
                    <section className='py-14'>
                            <div className='container mx-auto'>
                                <div className=' flex-col lg:flex-row bg-gradient-to-r from-violet-500 to-fuchsia-500 bg-no-repeat lg:h-[216px] px-5 lg:px-10 py-6 rounded-md w-10/12 cori'>
                                        ...
                                        <form action="" className="flex flex-col lg:flex-row w-full items-center gap-y-4 gap-x-6">
                                            <input type='text' placeholder='enter message' className='text-black w-1/2 text-xl border-b outline-none' />
